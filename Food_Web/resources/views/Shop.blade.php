                            ...
                            <div class="product__grid--inner">
                                <div class="product__grid--items d-flex align-items-center">
                                    ...
                                    <div class="product__grid--items--content">
                                        <h3 class="product__grid--items--content__title h4"><a href="#">Green-surface</a></h3>
                                ...
                                <div class="product__grid--items d-flex align-items-center">
                                    ...
                                    <div class="product__grid--items--content">
                                        <h4 class="product__grid--items--content__title"><a href="#">Fresh-whole</a></h4>
                                        <div class="product__items--price">
                                ...
                                <div class="product__grid--items d-flex align-items-center">
                                    ...
                                    <div class="product__grid--items--content">
                                        <h4 class="product__grid--items--content__title"><a href="#">Vegetables Juices</a></h4>
                                        <div class="product__items--price">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items product__items2">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="#">
                                                            <img class="product__items--img product__primary--img" src="{{ asset('storage/images/'.$shop->Product_Image) }}" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="{{ asset('storage/images/'.$shop->Product_Image) }}"  alt="product-img">
                                                        </a>
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items d-flex">
                                                <div class="product__items--thumbnail product__list--items__thumbnail"> 
                                                    <a class="product__items--link" href="#" style="width:350px;height:250px">
                                                        <img class="product__items--img product__primary--img" src="{{ asset('storage/images/'.$shop->Product_Image) }}" alt="product-img" >
                                                        <img class="product__items--img product__secondary--img" src="{{ asset('storage/images/'.$shop->Product_Image) }}" alt="product-img">
                                                    </a>
                                                    <div class="product__badge">
                                                ...
                                                <div class="product__list--items__content">
                                                    <h3 class="product__list--items__content--title h4 mb-10"><a href="#">{{$shop->Product_Name}}</a></h3>
                                                    ...
                                                    <p class="product__list--items__content--desc mb-20">{{$shop->Product_Des}}</p>
                                                    <a class="btn add__to--cart__btn2" href="{{ route('add.to.cart', $shop->Product_Id ) }}">+ Add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
