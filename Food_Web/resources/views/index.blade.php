                                ...
                                <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                                    <div class="col">
                                        <div class="slider__content slider__content--padding__left">
                                            ...
                                            <a class="btn slider__btn" href="{{url('shop')}}">Shop Now</a>
                                        </div>
                                    </div>
                                    <div class="col">
            ...
            <div class="product__section--inner product__swiper--activation swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="product__items product__bg">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="shop.html"><img class="product__items--img" src="assets/img/product/categories1.png" alt="categories-img">
                    ...
                    <div class="swiper-slide">
                        <div class="product__items product__bg">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="shop.html"><img class="product__items--img" src="assets/img/product/categories2.png" alt="categories-img">
                                    <div class="product__categories--content d-flex justify-content-between align-items-center">
                                        <div class="product__categories--content__left">
                    ...
                    <div class="swiper-slide">
                        <div class="product__items product__bg">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="shop.html"><img class="product__items--img" src="assets/img/product/categories3.png" alt="categories-img">
                                    <div class="product__categories--content d-flex justify-content-between align-items-center">
                                        <div class="product__categories--content__left">
                    ...
                    <div class="swiper-slide">
                        <div class="product__items product__bg">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="shop.html"><img class="product__items--img" src="assets/img/product/categories4.png" alt="categories-img">
                                    <div class="product__categories--content d-flex justify-content-between align-items-center">
                                        <div class="product__categories--content__left">
