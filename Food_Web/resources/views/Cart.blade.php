                            ...
                            <div class="cart__table">
                                <table class="cart__table--inner">
                                    ...
                                    <tbody class="cart__table--body">
                                        ...
                                        <tr class="cart__table--body__items" data-id="{{ $id }}">
                                            <td class="cart__table--body__list">
                                                <div class="cart__product d-flex align-items-center">
                                                    <button class="cart__remove--btn remove-from-cart"  aria-label="search button" type="button" >
                                                        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="16px" height="16px"><path d="M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.2929688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031 19.292969 L 13.414062 12 L 20.707031 4.7070312 L 19.292969 3.2929688 L 12 10.585938 L 4.7070312 3.2929688 z"/></svg>
                                                    </button>
                                                    <div class="cart__thumbnail">
                                                        <a href="#"><img class="border-radius-5" src="{{ asset('storage/images/'.$details['Product_Image']) }}" alt="cart-product"></a>
                                                    </div>
                                                    <div class="cart__content">
                                                        <h3 class="cart__content--title h4"><a href="#">{{ $details['Product_Name'] }}</a></h3>
                                            ...
                                            <td class="cart__table--body__list">
                                                ...
                                                <span class="old__price">Rs: {{ $details['Product_Price'] }}</span>     
                                                @endif

                                              
                                            </td>    
                                            <td class="cart__table--body__list">
                                                <input type="number" value="{{ $details['Product_Qty'] }}" class="form-control quantity__value quickview__value--quantity  quantity update-cart" />
                                            </td>
                                            ...
                                            @if ($details['Discount_Date'] < $formattedDate)
                                            <td data-th="Subtotal" class="text-center">Rs: {{ $details['Product_Price'] * $details['Product_Qty'] }}</td>
                                            @else
                                            <td data-th="Subtotal" class="text-center">Rs: {{ $details['Discount_Price'] * $details['Product_Qty'] }}</td> 
                                            @endif
                                        ...
                                        {{-- <tr class="cart__table--body__items">
                                            <td class="cart__table--body__list">
                                                <div class="cart__product d-flex align-items-center">
                                                    ...
                                                    <div class="cart__thumbnail">
                                                        <a href="#"><img class="border-radius-5" src="assets/img/product/product2.png" alt="cart-product"></a>
                                                    </div>
                                                    <div class="cart__content">
                                                        <h3 class="cart__content--title h4"><a href="#">Vegetable-healthy</a></h3>
                                ...
                                <div class="continue__shopping d-flex justify-content-between">
                                    ...
                                    <button class="continue__shopping--clear" type="submit"> <a href="{{url('destory-session')}}" onclick="return confirm('remove item from cart?')"> Clear Cart</a></button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="cart__summary border-radius-10">
                                    ...
                                    <table class="cart__summary--total__table">
                                        <tbody>
                                            <tr class="cart__summary--total__list">
                                                ...
                                                <td class="cart__summary--amount text-right">Rs: {{$total}}</td>
                                            </tr>
                                            <tr class="cart__summary--total__list">
                                ...
                                <div class="cart__summary--footer">
                                    ...
                                    <ul class="d-flex justify-content-between">
                                        ...
                                        <li><a class="cart__summary--footer__btn btn checkout" href="{{url('checkout')}}">Proceed To Checkout</a></li>
                                    </ul>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div class="product__items product__items2">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="#">
                                    <img class="product__items--img product__primary--img" src="{{ asset('storage/images/'.$shop->Product_Image) }}" alt="product-img" style="width:250px;height:250px;">
                                    <img class="product__items--img product__secondary--img" src="{{ asset('storage/images/'.$shop->Product_Image) }}" alt="product-img" style="width:250px;height:250px;">
                                </a>
                                <div class="product__badge">
                                    ...
                                    @if ($shop->Discount_Date < $formattedDate)
                            ...
                            <div class="product__items--content product__items2--content text-center">
                                <a class="add__to--cart__btn" href="{{ route('add.to.cart', $shop->Product_Id ) }}">+ Add to cart</a>
                                <h3 class="product__items--content__title h4"><a href="#">{{$shop->Product_Name}}</a></h3>
                                <div class="product__items--price">
                                    ...
                                    @if ($shop->Discount_Date < $formattedDate)
                                    <span class="current__price">Rs: {{$shop->Product_Price}}</span>
                                    @else
                                    <span class="current__price">Rs: {{$shop->Discount_Price}} </span>  
                                    <span class="old__price">Rs: {{$shop->Product_Price}}</span>     
                                    @endif
                                ...
                                <div class="product__items--rating d-flex justify-content-center align-items-center">
                                    ...
                                    <span class="product__items--rating__count--number">({{$shop->Product_Qty}})</span>
                                </div>
                            </div>
                        </div>
                    </div>
