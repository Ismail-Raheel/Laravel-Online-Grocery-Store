            ...
            <div class="container">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="{{url('index')}}"><img class="main__logo--img" src="assets/img/logo/nav-log.png" alt="logo-img"></a></h1>
                    </div>
                    <div class="header__menu d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="#">Welcome {{ session()->get('User_Name') }}</a>
                                </li>
                            
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="{{ url('Users_Logout') }}">Sign Out</a>
                                </li>

                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="{{ url('Order_History') }}">Order History</a>
                                </li>
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="#">Guest</a>
                                </li>
                                @endif
                    ...
                    <div class="header__account">
                        <ul class="d-flex">
                            ...
                            <li class="header__account--items d-none d-lg-block">
                                <a class="header__account--btn" href="{{url('Users_Register')}}">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                    ...
                                    <span class="items__count"> {{ count((array) session('cart')) }}  </a></span> 
        ...
        <div class="offCanvas__minicart">
            <div class="minicart__header ">
                <div class="minicart__header--top d-flex justify-content-between align-items-center">
                   ...
                   <span class="minicart__title"> Shopping Cart   </span>
                        <li class="header__account--items">
                            <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16.706" height="15.534" viewBox="0 0 14.706 13.534">
                                    <g id="cart" transform="translate(0 0)">
            ...
            <div class="minicart__product">
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.html"><img src="{{ asset('storage/images/'.$details['Product_Image']) }}" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                            <h4 class="minicart__subtitle"><a href="#">{{ $details['Product_Name'] }}</a></h4>
                            ...
                            <div class="minicart__price">
                                ...
                                <span class="current__price">Rs: {{ $details['Product_Price'] }}</span>
                                @else
                                <span class="current__price">Rs: {{ $details['Discount_Price'] }}</span>  
                        ...
                        <div class="minicart__text--footer d-flex align-items-center">
                            ...
                            <button class="minicart__product--remove remove-from-cart" type="button">Remove</button>
                        </div>
                    </div>
                </div>
...
{{--        
            ...
            <div class="minicart__button d-flex justify-content-center">
                <a class="btn minicart__button--link" href="{{ route('Cart') }}">View cart</a>
                <a class="btn minicart__button--link" href="{{url('checkout')}}">Checkout</a>
            </div>
